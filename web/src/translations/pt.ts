import { pt as customTranslations } from '../custom/translations/pt';
...
'page.body.wallets.tab.transfer': 'Transferir',
'page.body.wallets.overview.header.wallet': 'Carteira',
'page.body.wallets.overview.header.total': 'Valor Total',
